...
// end license header
//
//Updated for Pixy2 on I2C and parameters for pan tilt with sg09
// By Gabriel Dimitriu 2021
...
Pixy2I2C pixy;
PIDLoop panLoop(-300, 0, -5, true); //400,0,400
PIDLoop tiltLoop(-400, 0, -5, true);//500,0,500
