...
char colPins[KEYPAD_COLS] = {6,5,4,3}; //connect to the row pinouts of the keypad (31,30,29,28) vs orig {6,5,4,3}
char rowPins[KEYPAD_ROWS] = {11,10,9,8}; //connect to the column pinouts of the keypad (35,34,33,32) vs orig {11, 10, 9,8 }
