...
EnginesSubSystemArduinoShield *engines;
...
//  sensors->attachFrontRightSensor(RIGHT_SENSOR_PIN, LOW);
  ...
  //engines
  engines = new EnginesSubSystemArduinoShield();
  engines->addLeftMotorSettings(LEFT_MOTOR_PIN1, LEFT_MOTOR_PIN2);
  engines->addRightMotorSettings(RIGHT_MOTOR_PIN1, RIGHT_MOTOR_PIN2);
