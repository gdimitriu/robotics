 ...
 */
#pragma once
#ifndef EnginesSubSystemArduinoShield_h
#define EnginesSubSystemArduinoShield_h

#include "EnginesSubSystem.h"

class EnginesSubSystemArduinoShield : public EnginesSubSystem
{
public:
	void addLeftMotorSettings(int firstPin, int secondPin);
	void addRightMotorSettings(int firstPin, int secondPin);
	/*
