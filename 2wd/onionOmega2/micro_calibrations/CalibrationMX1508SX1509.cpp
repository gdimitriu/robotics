...
#include "CalibrationMX1508SX1509.h"
...
int main()
{
	CalibrationMX1508SX1509* droid = new CalibrationMX1508SX1509();
	droid->start();
	delete droid;
}

CalibrationMX1508SX1509::CalibrationMX1508SX1509() {
	//settings for micro see documentation from docs when it will be available
	m_engines = new EnginesWithEncoderMX1508SX1509(3, 1452, 1468, 9, 10, 3, 2);
...
void CalibrationMX1508SX1509::printMenu() {
	printf("Calibrations of SX1509 with MX1508 on onion Omega\n");
...
void CalibrationMX1508SX1509::start() {
	char *last;
	float fValue;
	long lValue;
	printMenu();
