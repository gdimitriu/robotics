...
#include "CalibrationMX1509PCA9685.h"
...
int main() {
	CalibrationMX1509PCA9685 *droid = new CalibrationMX1509PCA9685();
	droid->start();
	delete droid;
}

CalibrationMX1509PCA9685::CalibrationMX1509PCA9685() {
	m_pwmExpander = new Adafruit_PWMServoDriver(0x40);
	m_pwmExpander->setOscillatorFrequency(27000000);
	m_pwmExpander->setPWMFreq(50.0);
	m_engines = new EnginesWithEncoderMX1509PCA9685(m_pwmExpander, 3, 1452,
			1468, 9, 10, 3, 2);
...
void CalibrationMX1509PCA9685::printMenu() {
...
void CalibrationMX1509PCA9685::start() {
	char *last;
	float fValue;
	long lValue;
	printMenu();
